...
В результате тестирования план был доработан, поэтому были реализованы 10 запланированных и 57 дополнительных тестов. Из них 33 проверяют форму для покупки в кредит и 34 - покупки дебетовой картой. В обеих формах проверяются различные варианты заполнения полей, оповещения, появляющиеся при взаимодействии с формой, а так же информация, отправляемая в базу данных.
...
**Успешные: 56,71%(38 тестов)**

**Провалившиеся: 43,28%(29 тестов)**
